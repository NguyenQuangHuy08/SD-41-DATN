...
<body>
<div class="container">
    <h3 style="text-align: center;">Create chương trình giảm giá giầy thể thao</h3>
    <div>
        <h1 style="text-align: center; color: black; margin-top: 30px; margin-bottom: 60px">Thêm dữ liệu bảng giảm giá giầy thể thao</h1>
        <frm:form
            ...
            <div class="row">
                <div class="col-6">
                    <label style="margin-left: 30px">Tên chương trình giảm giá giầy thể thao</label>
                    <frm:input path="tenChuongTrinhGiamGia" cssStyle="width: 300px;" placeholder="text" value=""/>
                    <frm:errors path="tenChuongTrinhGiamGia"></frm:errors>
                    <label class="">${erCheckTenSanPhamNotTrim}</label>
                    <label>${erCheckTenSanPham}</label>
                </div>
                <div class="col-6">
                ...
                <div class="col-6">
                    ...
                    <frm:input path="ngayBatDau" cssStyle="width: 200px;" type="date" value=""/>
                </div>
                <div class="col-6">
