...
<div class="container">
    ...
    <div><a href="${pageContext.request.contextPath}/HuongDanBaoQuan/create" class="btn btn-primary">Thêm sản phẩm</a></div>
    ...
    <table class="table table-striped">
        ...
        <c:forEach var="hdbq" items="${listPage}" varStatus="i">
            <tr>
                ...
                <td style="padding-top: 55px; text-align: center">${hdbq.trangThai==1 ?"Còn" : "Hết"}</td>
                <td>
    ...
    <ul class="pagination" style="margin-left: 500px">
        <c:forEach begin="1" end="${totalPage}" varStatus="status">
            <li class="page-item">
                <a href="${pageContext.request.contextPath}/HuongDanBaoQuan/list?pageNumber=${status.index}" class="page-link">${status.index}</a>
            </li>
        </c:forEach>
    </ul>
</div>
