...
<body class="container">
    <form action="/day-giay/update/${cd.id}" method="post">
        <label class="form-label">ID</label>
        <input type="text" class="form-control" name="id" value="${cd.id}">
        <label class="form-label">Ten Day Giay</label>
        <input type="text" class="form-control" name="tenDayGiay" value="${cd.tenDayGiay}">
        <label class="form-label">Chieu Dai Day Giay</label>
        <input type="text" class="form-control" name="chieuDaiDayGiay" value="${cd.chieuDaiDayGiay}">
