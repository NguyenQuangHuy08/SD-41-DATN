...
<h1>Form Control</h1>
<form action="/trong-luong/add" method="post">
    <label class="form-label">Ten Trong Luong</label>
    <input type="text" class="form-control" name="tenTrongLuong">
...
<table class="table table-bordered">
    ...
    <tr>
        ...
        <th scope="col">ID</th>
        <th scope="col">Ten Trong Luong</th>
    ...
    <tbody>
    <tr>
        <c:forEach items="${trongLuong}" var="fm">
        <td>${fm.id}</td>
        <td>${fm.tenTrongLuong}</td>
        <td>${fm.ghiChu}</td>
        <td>${fm.ngayTao}</td>
        <td>${fm.ngaySua}</td>
        <td>${fm.trangThai}</td>
        <td>
            <a href="/trong-luong/delete/${fm.id}"><button type="button" class="btn btn-outline-primary">Delete</button></a>
            <a href="/trong-luong/view-update/${fm.id}"><button type="button" class="btn btn-outline-primary">View Update</button></a>
        </td>
    </tr>
    </c:forEach>
    </tr>
