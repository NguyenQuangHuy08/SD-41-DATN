...
<body>
<div class="container">
    <h3 style="text-align: center;">Edit màu sắc</h3>
    <div>
        <h1 style="text-align: center; color: black; margin-top: 30px; margin-bottom: 60px">Edit dữ liệu bảng màu sắc</h1>
        <frm:form
            ...
            <div class="row">
                <div class="col-6">
                    ...
                    <frm:errors path="tenMauSac"></frm:errors>
                    <label class="">${checkMauSacNotNull}</label>
                    <label>${checkMauSacHopLe}</label>
                </div>
                <div class="col-6">
